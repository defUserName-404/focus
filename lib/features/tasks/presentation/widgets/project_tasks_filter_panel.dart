...
import '../providers/task_filter_state.dart';
import '../providers/task_provider.dart';

/// Filter controls for a project's task list (sheet / popover content).
class ProjectTasksFilterPanel extends ConsumerWidget {
  final String projectIdString;

  const ProjectTasksFilterPanel({super.key, required this.projectIdString});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final filter = ref.watch(taskListFilterProvider(projectIdString));
    final notifier = ref.read(taskListFilterProvider(projectIdString).notifier);
